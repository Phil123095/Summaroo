...
function Footer() {
  ...
  return (
    <footer>
      <div className="md:max-w-8xl md:mx-auto px-4 sm:px-6">

        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-12 gap-8 py-4 px-10 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="/summarize" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Summarization Tool</Link>
              </li>                            
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            <h6 className="text-gray-800 font-medium mb-2">{register_message}</h6>
              ...
              <div className="flex flex-wrap mb-4">
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    <input id="newsletter" type="email" className="form-input w-full text-gray-800 px-3 py-2 pr-12 text-sm" onChange={(e) => onFormChange(e)} placeholder={emailError} required />
                    <button type="submit" className="absolute inset-0 left-auto" aria-label="Subscribe" onClick={SaveEmail}>
                      ...
                      {/*(register_message === 'Subscribed!') ? 
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 fill-current text-blue-600 mx-3 flex-shrink-0" fill="none" viewBox="0 0 12 12" stroke="currentColor">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <a className="text-blue-600 hover:underline" href="https://www.summarooapp.com/">Summaroo</a>. All rights reserved.</div>
