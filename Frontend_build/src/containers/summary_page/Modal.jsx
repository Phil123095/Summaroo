...
export const Modal = (props) => {
    const setReviewed = props.setReviewed
    return(
        <div class=" justify-center items-center w-full h-full fixed pin z-50 overflow-auto bg-smoke-light flex antialiased">
            <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
                <div
                    class="flex flex-row justify-between p-6 bg-white border-b border-gray-200 rounded-tl-lg rounded-tr-lg"
                >
                    <p class="font-semibold text-center text-gray-800">We'd love to hear your feedback!</p>
                    <button>
                        <svg
                            class="w-6 h-6"
                            fill="none"
