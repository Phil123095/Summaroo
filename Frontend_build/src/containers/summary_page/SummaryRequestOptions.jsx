    ...
    return(
        <>
            ...
            {/*<div class="m-2 mb-3 h-10 md:h-20 col-span-1 md:col-span-4 border-slate-100 rounded-lg bg-slate-100 items-center">
                <button class="w-full h-30 inline-flex justify-center items-center bg-green-primary bg-opacity-90 border-green-primary border-opacity-80 hover:bg-green-primary h-16 border rounded-lg animate-none" onClick={props.SummarizeText}>
                    ...
                    {props.Isloading === true ? <p class="text-base text-white">PERFORMING MAGIC</p> : <p class="text-base text-white">SUMMARIZE</p>}
                </button>
